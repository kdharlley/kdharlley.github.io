# a5_player.py
# STUDENTS: Kenneth Harlley, kdh62
...
class RankThenSuitAiPlayer(Player):
    ...
    def suggestACard(self, topCardInPile, attemptsRemaining):
        ...
        if topCardInPile==None:
            card_return = self._pickRandomCardHelper()
            return card_return
        
        while card_in_hand_num < len(self.hand):
            card_in_hand=self.hand[card_in_hand_num]
            if (topCardInPile.rank==card_in_hand.rank and
                card_in_hand.rank!=13 and card_in_hand.rank!=1):
                return card_in_hand
            card_in_hand_num +=1
        ...
        while card_in_hand_num < len(self.hand):
            card_in_hand=self.hand[card_in_hand_num]
            if (topCardInPile.suit == card_in_hand.suit and
                card_in_hand.rank!=13 and card_in_hand.rank!=1):
                return card_in_hand
            card_in_hand_num +=1
        ...
        while card_in_hand_num < len(self.hand):
            card_in_hand=self.hand[card_in_hand_num]
            if card_in_hand.rank==13 or card_in_hand.rank==1:
                return card_in_hand
            card_in_hand_num +=1
